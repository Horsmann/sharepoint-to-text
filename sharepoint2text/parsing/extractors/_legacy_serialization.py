"""Internal serialization retained for extractor characterization only."""
...
def _get_type_registry() -> dict[str, type]:
    ...
    # Import all private extractor record types lazily.
    from sharepoint2text.parsing.extractors import _legacy_types

    for name in dir(_legacy_types):
        obj = getattr(_legacy_types, name)
